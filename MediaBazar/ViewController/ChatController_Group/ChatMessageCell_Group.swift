...
class ChatMessageCell_Group: UICollectionViewCell {
...
//        view.roundCorners(corners: [.layerMaxXMaxYCorner, .layerMinXMinYCorner, .layerMinXMaxYCorner], radius: 8)
    ...
    var nameRightAnchor: NSLayoutConstraint?
    ...
    override init(frame: CGRect) {
        ...
        nameLeftAnchor = nameLabel.leftAnchor.constraint(equalTo: bubbleView.leftAnchor, constant: 2)
        nameLeftAnchor?.isActive = true
        nameRightAnchor = nameLabel.rightAnchor.constraint(equalTo: bubbleView.rightAnchor, constant: -2)
        nameRightAnchor?.isActive = true
        nameLabel.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -5).isActive = true
        
        profileImage.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 8).isActive = true
        profileImage.bottomAnchor.constraint(equalTo: self.bubbleView.bottomAnchor).isActive = true
