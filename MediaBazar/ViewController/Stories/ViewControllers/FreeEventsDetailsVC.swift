...
class FreeEventsDetailsVC: UIViewController {
    ...
    @IBOutlet weak var DropAero: UILabel!
    ...
    func setupUI() {
       ...
       func setupData() {
        for data in storyDetailData.uploadThumbnails.enumerated() {
    ...
    @objc func buyNowbuttonPreesed() {
        let buyEventVC = self.storyboard?.instantiateViewController(withIdentifier: "BuyFreeEventVC") as! BuyFreeEventVC
    ...
    @objc func nameButtonPressed(){
       let ProfileDetailVC = self.storyboard?.instantiateViewController(withIdentifier: "ProfileDeatailsVC") as! ProfileDeatailsVC
        ProfileDetailVC.journalistIDByStory = storyDetailData.journalistId.id
...
extension FreeEventsDetailsVC: UITableViewDataSource, UITableViewDelegate {
...
//                cell.labelDollar.isHidden = true
...
//                let arrdata = storyDetailData.docs[indexPath.row]
                cell.labelProfileName.text = ("\(storyDetailData.journalistId.firstName) \(storyDetailData.journalistId.lastName)")
                cell.labelEventName.text = storyDetailData.headLine
                cell.labelTechnology.text = storyDetailData.storyCategory
                cell.labelTime.text = ("\(storyDetailData.langCode) | \(storyDetailData.createdAt) | \(storyDetailData.country.name)")
                cell.labelPriceRete.text = String(storyDetailData.price)
                cell.storyCategoryLabel.text = storyDetailData.storyCategory
                ...
                //cell.labelDescription.text = storyDetailData.briefDescription
                
                cell.keyword = storyDetailData.keywordName
...
extension FreeEventsDetailsVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
