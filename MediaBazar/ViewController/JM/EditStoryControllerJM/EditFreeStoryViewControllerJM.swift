//
//  EditFreeStoryViewControllerJM.swift
//  MediaBazar
//
...
class EditFreeStoryViewControllerJM: UIViewController {
    ...
    @objc func onClickContinueButton(){
        ...
        updateFreeStory(storyID: storyDetailData.id, headline: headlineTextField.text!, categoryID: categoryId, languageCode: languageTextField.text!, country: countryData, state: stateData, city: cityData, date: dateTextField.text!, stepCount: "1", keyWords: keywordsArrayConvertedFormat, storyCategory: "Free", descri: textView.text!, header: currenUserLogin.token)
    ...
    func updateFreeStory(storyID: String,headline: String, categoryID : String, languageCode : String, country: String, state: String, city: String, date: String, stepCount: String,keyWords: String, storyCategory: String, descri : String, header: String){
        Webservices.sharedInstance.updateFreeSellStrotyForm(storyID: storyID, headLine: headline, categoryId: categoryID, languageCode: languageCode, country: country, state: state, city: city, date: date, stepCount: stepCount, keyWordName: keyWords, storyCategory: storyCategory, description: descri, header: header){
...
extension EditFreeStoryViewControllerJM: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension EditFreeStoryViewControllerJM: UITextFieldDelegate {
...
extension EditFreeStoryViewControllerJM: SendNameOfCountry {
...
extension EditFreeStoryViewControllerJM: SendNameOfState {
...
extension EditFreeStoryViewControllerJM: SendNameOfCity {
...
//-----gettingJob Keywords-------
extension EditFreeStoryViewControllerJM: SendKeywordName{
...
extension EditFreeStoryViewControllerJM : SendNameOfCategory{
...
extension EditFreeStoryViewControllerJM : SendNameOfLanguage{
