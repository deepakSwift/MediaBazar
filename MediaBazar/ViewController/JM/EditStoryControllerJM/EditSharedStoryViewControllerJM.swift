//
//  EditSharedStoryViewControllerJM.swift
//  MediaBazar
//
...
class EditSharedStoryViewControllerJM: UIViewController {
    ...
    func setUpPerviousData(){
        ...
        purchesTextField.text = storyDetailData.purchasingLimit
        ...
        priceTextField.text = storyDetailData.realPrice
    ...
    @objc func onClickContinueButton(){
        ...
        guard let purchaseLimit = purchesTextField.text, purchaseLimit != "" else {
            NKToastHelper.sharedInstance.showErrorAlert(self, message: "Please enter the purches limit")
            return
        }
        ...
        updateSharedSellStory(storyID: storyDetailData.id, headline: headlineTextField.text!, purchaseLimit: purchesTextField.text!, categoryID: categoryId, languageCode: languageTextField.text!, country: countryData, state: stateData, city: cityData, date: dateTextField.text!, stepCount: "1", keyWords: keywordsArrayConvertedFormat, storyCategory: "Shared", currency: currencyCode, price: priceTextField.text!, descri: textView.text!, header: currenUserLogin.token)
        
    }
    
    
    
    func updateSharedSellStory(storyID: String,headline: String,purchaseLimit: String, categoryID : String, languageCode : String, country: String, state: String, city: String, date: String, stepCount: String,keyWords: String, storyCategory: String, currency: String, price: String, descri : String, header: String){
        Webservices.sharedInstance.updateSharedSellStrotyForm(storyID: storyID, headLine: headline, purchaseLimit: purchaseLimit, categoryId: categoryID, languageCode: languageCode, country: country, state: state, city: city, date: date, stepCount: stepCount, keyWordName: keyWords, storyCategory: storyCategory, currency: currency, price: price, description: descri, header: header){
...
extension EditSharedStoryViewControllerJM: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension EditSharedStoryViewControllerJM: UITextFieldDelegate {
...
extension EditSharedStoryViewControllerJM: SendNameOfCountry {
...
extension EditSharedStoryViewControllerJM: SendNameOfState {
...
extension EditSharedStoryViewControllerJM: SendNameOfCity {
...
//-----gettingJob Keywords-------
extension EditSharedStoryViewControllerJM: SendKeywordName{
...
extension EditSharedStoryViewControllerJM : SendNameOfCategory{
...
extension EditSharedStoryViewControllerJM : SendNameOfLanguage{
...
extension EditSharedStoryViewControllerJM: SendNameOfCurrency {
