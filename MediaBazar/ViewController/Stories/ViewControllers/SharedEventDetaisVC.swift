...
class SharedEventDetaisVC: UIViewController {
    ...
    //    var sharedDetailData = listStory()
    var sharedDetailData = storyListModal()
    var thumbnailImage = ""
    ...
    func setupData() {
        ...
        for data in sharedDetailData.uploadThumbnails.enumerated() {
            let tempData = data.element.thumbnale
            thumbnailImage = tempData
            
        }
        
        //        for journalistDataID in sharedDetailData.docs.enumerated(){
    ...
    @objc func buyNowbuttonPreesed() {
        let buyEventVC = self.storyboard?.instantiateViewController(withIdentifier: "BuySharedEventVC") as! BuySharedEventVC
    ...
    @objc func nameButtonPressed(){
        ...
        ProfileDetailVC.journalistIDByStory = sharedDetailData.journalistId.id
...
extension SharedEventDetaisVC: UITableViewDataSource, UITableViewDelegate {
...
//
//                //                let arrdata = sharedDetailData.docs[indexPath.row]
//                cell.labelProfileName.text = ("\(sharedDetailData.journalistId.firstName) \(sharedDetailData.journalistId.lastName)")
//                cell.labelEventName.text = sharedDetailData.headLine
//                cell.labelTechnology.text = sharedDetailData.storyCategory
//                cell.labelTime.text = ("\(sharedDetailData.langCode) | \(sharedDetailData.createdAt) | \(sharedDetailData.country.name)")
//                cell.labelPriceRete.text = String(sharedDetailData.price)
//                cell.storyCategoryLabel.text = sharedDetailData.storyCategory
...
//                cell.labelDescription.text = sharedDetailData.briefDescription
//
//                cell.keyword = sharedDetailData.keywordName
...
extension SharedEventDetaisVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
