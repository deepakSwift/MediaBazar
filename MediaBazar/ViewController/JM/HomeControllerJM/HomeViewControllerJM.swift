...
class HomeViewControllerJM: UIViewController {
    ...
    fileprivate func setupScrollView() {
        ...
        let firstVC = storyboard? .instantiateViewController(withIdentifier: "AllHomeViewControllerJM")
        self.addChild(firstVC!)
        let secondVC = storyboard?.instantiateViewController(withIdentifier: "ExclusiveHomeViewControllerJM")
        self.addChild(secondVC!)
        let thiredVC = storyboard?.instantiateViewController(withIdentifier: "SharedHomeViewControllerJM")
        self.addChild(thiredVC!)
        let fourthVC = storyboard?.instantiateViewController(withIdentifier: "FreeHomeViewControllerJM")
        self.addChild(fourthVC!)
        let fifthVC = storyboard?.instantiateViewController(withIdentifier: "AuctionHomeViewControllerJM")
    ...
    @objc func notificationButtonPressed() {
        let notificationVC = AppStoryboard.Journalist.viewController(NotificationViewControllerJM.self)
        navigationController?.pushViewController(notificationVC, animated: true)
    }
    
    @objc func liveButtonPressed(){
        let liveVC = AppStoryboard.Journalist.viewController(AssignmentListViewControllerJournalist.self)
...
extension HomeViewControllerJM: UIScrollViewDelegate {
    ...
    func loadScrollViewWithPage(_ page: Int) {
        ...
        var firstVC: AllHomeViewControllerJM
        var secondVC: ExclusiveHomeViewControllerJM
        var thirdVC: SharedHomeViewControllerJM
        var fourthVC: FreeHomeViewControllerJM
        var fifthVC: AuctionHomeViewControllerJM
        
        
        var frame: CGRect = scrollView.frame
        switch page {
        case 0:
            firstVC = self.children[page] as! AllHomeViewControllerJM
        ...
        case 1:
            secondVC = self.children[page] as! ExclusiveHomeViewControllerJM
        ...
        case 2:
            thirdVC = self.children[page] as! SharedHomeViewControllerJM
        ...
        case 3:
            fourthVC = self.children[page] as! FreeHomeViewControllerJM
        ...
        case 4:
            fifthVC = self.children[page] as! AuctionHomeViewControllerJM
