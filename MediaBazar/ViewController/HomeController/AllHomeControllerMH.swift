...
class AllHomeControllerMH: UIViewController {
...
//        searchingBar.searchTextField.backgroundColor = .white
        getAllStoryData(page: "0", key: "All", header: currenUserLogin.mediahouseToken)
    }
    ...
    fileprivate func setupTableView() {
        allHomeTableView.dataSource = self
        allHomeTableView.delegate = self
        allHomeTableView.bounces = false
        allHomeTableView.alwaysBounceVertical = false
        allHomeTableView.rowHeight = UITableView.automaticDimension
        allHomeTableView.estimatedRowHeight = 1000
    }
        ...
        WebService3.sharedInstance.AddToFavoriteStroy(storyId: storyId, storyHeader: header) { (result, message, response) in
            ...
            if result == 200{
                ...
                if self.isSearching == true {
                    self.getAllStoryData(page: "0", key: "All", header: self.currenUserLogin.mediahouseToken)
                }else {
                    self.getSearchData(page: "0", key: "All", searchKey: self.searchText, header: self.currenUserLogin.mediahouseToken)
                }
            }else{
                if self.isSearching == true {
                    self.getAllStoryData(page: "0", key: "All", header: header)
                }else {
                    self.getSearchData(page: "0", key: "All", searchKey: self.searchText, header: self.currenUserLogin.mediahouseToken)
                }
                NKToastHelper.sharedInstance.showAlert(self, title: warningMessage.title, message: message)
...
extension AllHomeControllerMH: UITableViewDataSource, UITableViewDelegate {
...
//            return allStoryList.docs.count
            ...
            print("count=======================\(searchStoryList.count)")
...
//            let arrdata = allStoryList.docs[indexPath.row]
            ...
            if arrdata.totalAveargeReview == 0.0 {
            ...
            if arrdata.storyCategory == "Free" {
                ...
                cell.timeLeftlabelTag.isHidden = true
                cell.soldOutCount.isHidden = false
                cell.priceTag.text = "Price :"
                cell.soldOutLabelTag.text = "Sold Out"
                ...
                cell.soldOutCount.isHidden = true
                cell.soldOutLabelTag.isHidden = true
                ...
                //                cell.ratingLabel.isHidden = true
                cell.priceTag.isHidden = false
                cell.priceTag.text = "Minimum Bidding Price :"
                cell.buttonBuyNow.isHidden = false
                cell.timeLeftlabel.isHidden = false
                cell.timeLeftlabelTag.isHidden = false
                cell.soldOutCount.isHidden = true
                cell.soldOutLabelTag.text = "Available for Sale"
...
//            let arrdata = searchAllStoryList.docs[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        if (totalPaginationPage - 3) == indexPath.row {
            ...
            if self.typeOfData == "all"{
                getAllStoryData(page: "\(page)", key: "All", header: currenUserLogin.mediahouseToken)
            }else if typeOfData == "filter"{
                getFilterStoryData(page: "\(page)", key: "All", categoryId: self.getFilterID, header: currenUserLogin.mediahouseToken)
            }else if typeOfData == "search"{
                getSearchData(page: "\(page)", key: "All", searchKey: self.searchText, header: currenUserLogin.mediahouseToken)
            }else {
                return
            }
        }
...
extension AllHomeControllerMH: UISearchBarDelegate {
    //----------- SearchBar Delegate --------------
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        if searchBar.text != "" && searchBar.text != nil {
            ...
            self.page = 0
            self.totalPages = 0
            getSearchData(page: "0", key: "All", searchKey: searchBar.text!, header: self.currenUserLogin.mediahouseToken)
        } else {
            isSearching = true
            self.storyList.removeAll()
            self.page = 0
            self.totalPages = 0
            getAllStoryData(page: "0", key: "All", header: self.currenUserLogin.mediahouseToken)
        }
...
//------getting Filter data
extension AllHomeControllerMH: SendNameOfAreaFilter {
    func FilterName(name: String, id: String) {
        if name == "clearFilter" {
            ...
            self.getFilterID = id
            self.getFilterStoryData(page: "0", key: "All", categoryId: id, header: self.currenUserLogin.mediahouseToken)
        }
    }
}
