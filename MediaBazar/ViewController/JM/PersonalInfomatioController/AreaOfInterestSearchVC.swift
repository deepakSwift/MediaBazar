...
protocol SendNameOfAreaInterest {
    func AreaOfInterestName(name: String, id: String)
}

class AreaOfInterestSearchVC: UIViewController {

    @IBOutlet weak var searchBarView: UISearchBar!
    @IBOutlet weak var tableViewCountry: UITableView!
    
    var flag = false
    var delegate: SendNameOfAreaInterest!
    ...
    @IBAction func buttonActionDismiss(_ sender: Any) {
        self.dismiss(animated: true, completion: {
            self.delegate.AreaOfInterestName(name: "", id: "")
        })
    }
...
//------ TableView -------
extension AreaOfInterestSearchVC: UITableViewDataSource, UITableViewDelegate {
            ...
            if self.flag == true {
                ...
                for cityName in self.areaOfInterestArea {
                    if CountryName == cityName.categoryText {
                        ...
                        print("========\(CountryName)")
                        print("========\(countryId)")
                        self.delegate.AreaOfInterestName(name: CountryName, id: countryId)
                    }
                }
            } else {
...
extension AreaOfInterestSearchVC: UISearchBarDelegate {
