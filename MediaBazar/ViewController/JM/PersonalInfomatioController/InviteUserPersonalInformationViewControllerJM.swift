//
//  InviteUserPersonalInformationViewControllerJM.swift
//  MediaBazar
//
...
class InviteUserPersonalInformationViewControllerJM: UIViewController,CountryPickerViewDataSource, CountryPickerViewDelegate  {
    ...
    var buttonType: ButtonTypes = .ButtonProfilePhoto
    var mediaURL: URL?
    var countryData = ""
    var stateData = ""
    var cityData = ""
    ...
    override func viewDidLoad() {
        ...
        print("invitejournalistToken====\(invitejournalistToken)")
    }
...
//                popTip.show(text: "I have an offset to move the bubble down or left side.", direction: .right, maxWidth: 200, in: view, from: popTipButton.frame)
    ...
    //------ Call Api ----
    func personalInfo(profileImageUrl: UIImage, profileVideo: Data, mobileNumber: String, firstName:String, middleName: String, lastName: String, designationId: String, langCode: String, currency: String, pinCode: String, shortBio: String,mailingAdress : String, Country: String, state: String, city: String, stepCount: String, nameCode: String, phoneCode: String,stripID : String, header : String) {
        
        Webservice.sharedInstance.getInviteUserPersonalInfo(profileImageUrl: profileImageUrl, profileVideo: profileVideo, mobileNumber: mobileNumber, firstName: firstName, middleName: middleName, lastName: lastName, designationId: designationId, langCode: langCode,currency: currency, pinCode: pinCode, shortBio: shortBio, mailingAddress: mailingAdress, Country: Country, state: state, city: city, stepCount: stepCount, nameCode: nameCode, phoneCode: phoneCode, stripId: stripID, header: header){(result,response,message)  in
...
extension InviteUserPersonalInformationViewControllerJM: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension InviteUserPersonalInformationViewControllerJM: UITextFieldDelegate {
...
extension InviteUserPersonalInformationViewControllerJM: SendNameOfCountry {
...
extension InviteUserPersonalInformationViewControllerJM: SendNameOfState {
...
extension InviteUserPersonalInformationViewControllerJM: SendNameOfCity {
