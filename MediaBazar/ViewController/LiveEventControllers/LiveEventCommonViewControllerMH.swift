//
//  LiveEventCommonViewControllerMH.swift
//  MediaBazar
//
...
class LiveEventCommonViewControllerMH: UIViewController {
        ...
        func setupUI() {
            ...
            let MyAssignmentVC = storyboard?.instantiateViewController(withIdentifier: "NewEventViewControllerMH")
            self.addChild(MyAssignmentVC!)
            let JournalismVC = storyboard?.instantiateViewController(withIdentifier: "PurchasedEventViewControllerMH")
    ...
    extension LiveEventCommonViewControllerMH: UIScrollViewDelegate {
        ...
        func loadScrollViewWithPage(_ page: Int) {
            ...
            var firstVC : NewEventViewControllerMH
            var secondVC : PurchasedEventViewControllerMH
            
            var frame: CGRect = scrollView.frame
            switch page {
            case 0:
                firstVC = self.children[page] as! NewEventViewControllerMH
            ...
            case 1:
                ...
                secondVC = self.children[page] as! PurchasedEventViewControllerMH
