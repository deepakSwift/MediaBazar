//
//  EditBlogViewControllerJM.swift
//  MediaBazar
//
...
class EditBlogViewControllerJM: UIViewController {
    ...
    @objc func onClickContinueButton(){
        ...
        updateBlogStory(storyId: storyDetailData.id, headLine: headLineTextField.text!, categoryId: categoryId, languageCode: languageTextField.text!, country: countryData, state: stateData, city: cityData, date: dateTextField.text!, stepCount: "1", keyWordId: keywordsArrayConvertedFormat, description: textView.text!, header: currenUserLogin.token)
        
        
        //        }
    }
    
    func updateBlogStory(storyId: String, headLine: String, categoryId: String, languageCode: String, country: String, state: String, city: String, date: String, stepCount: String, keyWordId: String, description: String, header: String){
        Webservices.sharedInstance.updateblogFormFill(storyId: storyId, headLine: headLine, categoryId: categoryId, languageCode: languageCode, country: country, state: state, city: city, date: date, stepCount: stepCount, keyWordId: keyWordId, description: description, header: header){
...
extension EditBlogViewControllerJM: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension EditBlogViewControllerJM: UITextFieldDelegate {
...
extension EditBlogViewControllerJM: SendNameOfCountry {
...
extension EditBlogViewControllerJM: SendNameOfState {
...
extension EditBlogViewControllerJM: SendNameOfCity {
...
//-----gettingJob Keywords-------
extension EditBlogViewControllerJM: SendKeywordName{
...
extension EditBlogViewControllerJM : SendNameOfCategory{
...
extension EditBlogViewControllerJM : SendNameOfLanguage{
