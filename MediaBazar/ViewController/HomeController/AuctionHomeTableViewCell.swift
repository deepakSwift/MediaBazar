//
//  AuctionHomeTableViewCell.swift
//  MediaBazar
//
...
class AuctionHomeTableViewCell: UITableViewCell {
...
extension AuctionHomeTableViewCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
