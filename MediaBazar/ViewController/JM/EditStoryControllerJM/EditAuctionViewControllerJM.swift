//
//  EditAuctionViewControllerJM.swift
//  MediaBazar
//
...
class EditAuctionViewControllerJM: UIViewController {
    ...
    func setUpPerviousData(){
        ...
        currancyTextField.text = storyDetailData.realCurrencyName
        durationTextField.text = storyDetailData.auctionDuration
        priceTextField.text = storyDetailData.auctionBiddingPrice
        ...
        //-----CityData-----
        cityTextField.text = storyDetailData.city.name
    ...
    @objc func keywordButtonPressed() {
        let keywordVC = AppStoryboard.MediaHouse.viewController(CustomKeywordSearchVC.self)
    ...
    @objc func onClickContinueButton(){
        ...
        guard let duration = durationTextField.text, duration != "" else {
            NKToastHelper.sharedInstance.showErrorAlert(self, message: "Please enter the duration")
            return
        }
        ...
        guard let price = priceTextField.text, price != "" else {
            NKToastHelper.sharedInstance.showErrorAlert(self, message: "Please enter the bidding price")
            return
        }
        ...
        updateAuctionSellStor(storyID: storyDetailData.id, headLine: headlineTextField.text!, categoryId: categoryId, languageCode: languageTextField.text!, country: countryData, state: stateData, city: cityData, date: dateTextField.text!, stepCount: "1", auctionDuartion: durationTextField.text!, keyWordName: keywordsArrayConvertedFormat, storyCategory: "Auction", currency: currencyCode, biddingPrice: priceTextField.text!, description: textView.text!, header: currenUserLogin.token)
    ...
    func updateAuctionSellStor(storyID: String, headLine: String, categoryId: String, languageCode: String, country: String, state: String, city: String, date: String, stepCount: String, auctionDuartion: String, keyWordName: String, storyCategory: String, currency: String, biddingPrice: String, description: String, header: String){
        Webservices.sharedInstance.updateAuctionSellStrotyForm(storyID: storyID, headLine: headLine, categoryId: categoryId, languageCode: languageCode, country: country, state: state, city: city, date: date, stepCount: stepCount, auctionDuartion: auctionDuartion, keyWordName: keyWordName, storyCategory: storyCategory, currency: currency, biddingPrice: biddingPrice, description: description, header: header){
            (result,message,response) in
            if result == 200{
                print(response)
                let PostStoryTypeVC = AppStoryboard.Journalist.viewController(EditPostTypeStoryViewController.self)
...
extension EditAuctionViewControllerJM: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension EditAuctionViewControllerJM: UITextFieldDelegate {
...
extension EditAuctionViewControllerJM: SendNameOfCountry {
...
extension EditAuctionViewControllerJM: SendNameOfState {
...
extension EditAuctionViewControllerJM: SendNameOfCity {
...
//-----gettingJob Keywords-------
extension EditAuctionViewControllerJM: SendKeywordName{
...
extension EditAuctionViewControllerJM : SendNameOfCategory{
...
extension EditAuctionViewControllerJM : SendNameOfLanguage{
...
extension EditAuctionViewControllerJM: SendNameOfCurrency {
