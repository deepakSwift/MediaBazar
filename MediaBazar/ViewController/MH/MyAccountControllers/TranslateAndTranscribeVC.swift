//
//  TranslateAndTranscribeVC.swift
//  MediaBazar
//
...
class TranslateAndTranscribeVC: UIViewController {
    ...
    func getFilePrice(fileSize : String, fileType : String, header : String ) {
        Webservices.sharedInstance.getTranslateAndtranscribePriceMedia(fileSize: fileSize, fileType: fileType, header: header){(result,response,message)  in
...
extension TranslateAndTranscribeVC: UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate {
...
//--------GetLanguageName--------
extension TranslateAndTranscribeVC: SendNameOfToLanguage {
    func languageName(name: String, id: String, langKey: String) {
        ToLanguageTextFileld.resignFirstResponder()
        if name == "" && id == "" && langKey == ""{
            return
        }
...
extension TranslateAndTranscribeVC: UIDocumentPickerDelegate {
    ...
    func documentPicker(_ controller: UIDocumentPickerViewController, didPickDocumentsAt urls: [URL]) {
        ...
        do {
            ...
            getFilePrice(fileSize: "\(fileSize!)", fileType: "text", header: currentUserLogin.mediahouseToken)
        } catch {
            print("Error: \(error)")
        }
    }
...
extension TranslateAndTranscribeVC: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        if let chosenImage = info[.editedImage] as? UIImage{
            ...
            getFilePrice(fileSize: "\(durationInSeconds)", fileType: "video", header: currentUserLogin.mediahouseToken)
