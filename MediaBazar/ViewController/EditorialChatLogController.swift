//
//  EditorialChatLogController.swift
//  MediaBazar
//
...
class EditorialChatLogController: UIViewController {
    ...
    func observeMessages() {
        ...
        let messageIdRef = Database.database().reference().child("chat").child("editorial").child(chatID)
    ...
    func observeOnlineStatus() {
        let statusOnceRef = Database.database().reference().child("editorial").child((user?.receiverID)!)
        ...
        let statusRef = Database.database().reference().child("editorial").child((user?.receiverID)!)
    ...
    @objc func handleSendButton() {
        ...
        if firstMessage {
            ...
            let messageIdRef = Database.database().reference().child("chat").child("editorial")
...
extension EditorialChatLogController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate {
...
extension EditorialChatLogController: UITextFieldDelegate {
    
}


// MARK:- UIImagePickerControlle extension
extension EditorialChatLogController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension EditorialChatLogController: UITextViewDelegate {
