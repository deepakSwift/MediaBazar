...
class ProfileDeatailsVC: UIViewController {
    ...
    var journalistIDByStory = "5eee48bc48819844ff6a3383"
    ...
    override func viewDidLoad() {
        ...
        getProfileData(journalistID: journalistIDByStory, header: currentUserLogin.token)
        getStoryDataByID(journalistID: journalistIDByStory, page: "0", header: currentUserLogin.token)
        
//        getAllStoryData(page: "0", journalistID: journalistIDByStory, header: currentUserLogin.token)
    ...
    func getThumbnailImage(forUrl url: URL) -> UIImage? {
        ...
        func getProfileData(journalistID : String, header: String){
            Webservices.sharedInstance.getJournalistDataByStory(journalistID: journalistID, header: header){(result,message,response)  in
                if result == 200 {
    ...
    func getStoryDataByID(journalistID: String, page : String, header: String){
            Webservices.sharedInstance.getStoryListByID(journalistID: journalistID, page: page, header: header){(result,message,response) in
                print(result)
                if result == 200{
                    if let somecategory = response{
...
extension ProfileDeatailsVC : UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0{
            ...
            cell.totalAssignment.text = "Story(\(totalStory))"
