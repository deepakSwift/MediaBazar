...
class MyAssignmentsTableCell: UITableViewCell {
    ...
    @IBOutlet weak var reviewButttonConatinerView: UIView!
...
extension MyAssignmentsTableCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
