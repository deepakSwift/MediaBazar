//
//  FavouriteStoryDetailMediaViewController.swift
//  MediaBazar
//
//  Created by Abhinav Saini on 17/07/20.
//  Copyright © 2020 Saurabh Chandra Bose. All rights reserved.
//

import UIKit

    enum CellTypess: String {
        case collapseCell = "collapse"
        case expandCell =  "expand"
    }

    struct TableCellDatass {
        var open = Bool()
        var title = String()
        var sectionData = [String]()
    }

    class FavouriteStoryDetailMediaViewController: UIViewController {
        ...
        var cellType:CellTypess = .collapseCell
    ...
    // -----TableView------
    extension FavouriteStoryDetailMediaViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    // MARK:- Chat Method
    extension FavouriteStoryDetailMediaViewController: AccessEventDetailCell {
    ...
    extension FavouriteStoryDetailMediaViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
